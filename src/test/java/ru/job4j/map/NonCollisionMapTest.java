...
class NonCollisionMapTest {
    ...
    void whenLargeKey() {
        SimpleMap<Integer, String> map = new NonCollisionMap<>();
        assertThat(map.put(50000002, "5")).isTrue();
        assertThat(map.get(50000002)).isEqualTo("5");
    }

    @Test
    void whenNegativeKey() {
        SimpleMap<Integer, String> map = new NonCollisionMap<>();
        assertThat(map.put(-7, "5")).isTrue();
        assertThat(map.get(-7)).isEqualTo("5");
    }
